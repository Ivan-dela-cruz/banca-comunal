...
<section style="margin-bottom: 0px; height: auto;">
    ...
    <div class="box">
        <div class="box-1">
            <h1>Sr(a).</h1>
            <span>{!!$treatment->name_p!!} {!!$treatment->last_name_p!!}</span>
            <h1>Identificación</h1>
            <span>{{$treatment->ci}}</span>
            <h1>Correo</h1>
            <span style="text-transform: lowercase;">   {{$treatment->email}}</span>
            <h1>Télefono</h1>
            <span>   {{$treatment->phone}}</span>
            <h1>Dirección</h1>
            <span>  {{$treatment->address}}</span>
        </div>
        <div class="box-derecho">
            <div class="box-2">
                ...
                <h1>Fecha</h1>
                <span>  {{\Carbon\Carbon::parse($treatment->updated_at)->format('Y-m-d') }}</span>
                <h1>Estado</h1>
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                ...
                <th style="text-align: center; font-size: 12px;">${{$treatment->price_total}}</th>
            </tr>
            </tbody>
        </table>
    </div>
...
<section>
    <div>
        <table>
            ...
            <tr>
                <td style=" text-transform: uppercase;" >
                     @if (empty($treatment->description)||$treatment->description=="")
                        ---
                     @else
