...
<title>Reporte de pagos por pacient Souri - {{time()}}</title>
<style>
    body {
        /*position: relative;*/
        /*width: 16cm;  */
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 11px;" colspan="4">Reporte de pago preteneciente a -  {{$patient->last_name}} {{$patient->name}}   {{$patient->ci}}</th>
