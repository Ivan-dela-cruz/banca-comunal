    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 11px;" colspan="4">Reporte de Cuentas - {{time()}}</th>
            ...
            <tr style="text-align: left; background-color: #1C3FAA; border: 2px solid #1C3FAA;">
                ...
                <th style="text-align: center" width="120px">Cuenta</th>
            ...
            @foreach($accounts as $data)
                <tr>
                    ...
                    <td style="text-align: center">
                        {{$data->member->doc_number}}
                    </td>
                    <td style="text-align: center">
                        {{$data->member->last_name}} {{$data->member->name}}
                    </td>
                    <td style="text-align: center">
                        {{$data->type}}
                    </td>
