    ...
    <div class="box">
        ...
        <div class="box-derecho">
            <div class="box-2">
                ...
                <span>  {{\Carbon\Carbon::parse($dataOperation['settlement_date'])->format('Y-m-d') }}</span>

                <h1>Fecha de Vencimiento</h1>
                <span>  {{\Carbon\Carbon::parse($dataOperation['due_date'])->format('Y-m-d') }}</span>
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                ...
                <th>
                    <h1>Plazo</h1>
                    <span>  {{$dataOperation['term']}}</span>
                </th>

                <th>
                    <h1>Periodo</h1>
                    <span>  {{$dataOperation['period']}}</span>
                </th>
            </tr>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th>
                    ...
                    <span>  {{$dataOperation['interest_rate']}}</span>
                </th>
                <th>
                    <h1>Cuota Fija</h1>
                    <span>  {{$dataOperation['fixed_free']}}</span>
                </th>
                <th>
                    <h1>Tipo de Crédito</h1>
                    <span>  {{$dataOperation['credit_type']}}</span>
                </th>
            </tr>

            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 15px;" colspan="7">Dettalle de la Amortización</th>
            </tr>
