...
<title>Reporte de diagnósticos por paciente Souri - {{time()}}</title>
<style>
    body {
        /*position: relative;*/
        /*width: 16cm;  */
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 11px;" colspan="3">Reporte de diagnósticos preteneciente a -  {{$patient->last_name}} {{$patient->name}}   {{$patient->ci}}</th>
            ...
            <tr style="text-align: left; background-color: #5de2c9; border: 2px solid #5de2c9;">
                ...
                <th style="text-align: center" width="150px">Diagnóstico</th>
                <th style="text-align: center" width="120px">Descripción</th>
                <th style="text-align: center" width="120px">Reacción</th>
                
                <th style="text-align: center" width="75px">Registrado</th>
                <th style="text-align: center" width="75px">Modificado</th>
            ...
            @foreach($diagnostics as $diagnostic)
                <tr>
                    ...
                    <td>
                        ...
                        {{\Carbon\Carbon::parse($diagnostic->created_at)->toFormattedDateString()}}
                    </td>
                    <td>
                        {{\Carbon\Carbon::setLocale('es')}}
                        {{\Carbon\Carbon::parse($diagnostic->updated_at)->toFormattedDateString()}}
                    </td>
