...
<title>PDF-HISTORIAL MÉDICO-</title>
<style>
    body {
        /*position: relative;*/
        /*width: 16cm;  */
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 11px;">HISTORIAL MÉDICO</th>
        ...
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;">4. Alergias</th>
                <th style="text-align: left; color: #ffffff; width: 370px;">Reacción</th>
                <th style="text-align: left; color: #ffffff; width: 100px;">Modificado</th>
            ...
            @foreach($allergies as $allergy)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$allergy->allergy->name}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$allergy->description}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$allergy->updated_at}}</td>
                </tr>
            @endforeach
        ...
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;">5. Diagnósticos</th>
                <th style="text-align: left; color: #ffffff; width: 80px;">Código</th>
                <th style="text-align: left; color: #ffffff; width: 290px;">Reacción</th>
                <th style="text-align: left; color: #ffffff; width: 100px;">Modificado</th>
            ...
            @foreach($diagnostics as $diagnostic)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$diagnostic->diagnostic->name}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$diagnostic->diagnostic->code}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$diagnostic->description}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$diagnostic->updated_at}}</td>
                </tr>
            @endforeach
        ...
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;" colspan="5">6. Evoluciones</th>
            </tr>
            <tr style="text-align: left; background-color: #ffffff; border: 1px solid #d0d0d0; ">
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 130px;">Médico</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 50px;">Código</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 140px;">Diagnóstico</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 210px;">Evolución</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 100px;">Modificado</th>
            ...
            @foreach($evolutions as $evolution)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">
                        {{$evolution->name_d}} {{$evolution->last_name_d }}
                    </td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$evolution->code}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$evolution->name_dg}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$evolution->description}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$evolution->updated_at}}</td>
                </tr>
            @endforeach
        ...
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;" colspan="7">7. Citas médicas</th>
            </tr>
            <tr style="text-align: left; background-color: #ffffff; border: 1px solid #d0d0d0; ">
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 60px;">Especialidad</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Médico</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Motivo</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 140px;">Descripción</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 60px;">Hora</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 60px;">Fecha</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 40px;">Estado</th>
            ...
            @foreach($appointments as $appointment)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$appointment->specialty}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">
                        {{$appointment->name_d}} {{$appointment->last_name_d }}
                    </td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$appointment->reason}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$appointment->observation}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{\Carbon\Carbon::parse($appointment->start)->format('g:i A') }}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{\Carbon\Carbon::parse($appointment->date)->format('Y-m-d') }}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$appointment->status}}</td>
                </tr>
            @endforeach
        ...
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;" colspan="8">8. Tratamientos médicos</th>
            </tr>
            <tr style="text-align: left; background-color: #ffffff; border: 1px solid #d0d0d0; ">
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 60px;">Especialidad</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Médico</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Motivo</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 120px;">Descripción</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 50px;">Precio</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 40px;">Tipo</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 40px;">Estado</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 60px;">Registrado</th>
            ...
            @foreach($treatments as $treatment)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->name_s}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">
                        {{$treatment->name_d}} {{$treatment->last_name_d }}
                    </td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->reason}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->description}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">$ {{$treatment->price_total}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->status_pay}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->status}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$treatment->created_at}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
        <table>
            <thead>
            <tr style="text-align: left; background-color: #5de2c9; border: 1px solid #FFFFFF; ">
                <th style="text-align: left; color: #ffffff; width: 180px;" colspan="5">9. Recetas</th>
            </tr>
            <tr style="text-align: left; background-color: #ffffff; border: 1px solid #d0d0d0; ">

                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Médico</th>
                <th style="text-align: left; color:#000; border: 1px solid #d0d0d0; width: 120px;">Motivo</th>
                <th style="text-align: left;color:#000; border: 1px solid #d0d0d0; width: 175px;">Medicamento</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 175px;">Indicaciones</th>
                <th style="text-align: left; color:#000;border: 1px solid #d0d0d0; width: 60px;">Registrado</th>
            ...
            @foreach($recipes as $recipe)
                <tr>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">
                        {{$recipe->name_d}} {{$recipe->last_name_d }}
                    </td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$recipe->reason}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$recipe->medicines}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$recipe->indications}}</td>
                    <td style="text-align: left; border: 1px solid #d0d0d0;">{{$recipe->created_at}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
