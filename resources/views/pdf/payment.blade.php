...
<section style="margin-bottom: 0px; height: auto;">
    ...
    <h5 style=" margin-bottom: 0px;font-size: 13px;color: #238288;font-family: 'Montserrat', sans-serif; ">Pago del tartamiento</h5>
    <div class="box">
        <div class="box-1">
            <h1>Sr(a).</h1>
            <span>{!!$payment->name_p!!} {!!$payment->last_name_p!!}</span>
            <h1>Identificación</h1>
            <span>{{$payment->ci}}</span>
            <h1>Correo</h1>
            <span style="text-transform: lowercase;">   {{$payment->email}}</span>
            <h1>Télefono</h1>
        ...
        <div class="box-derecho">
            <div class="box-2">
                ...
                <h1>Fecha</h1>
                <span>  {{\Carbon\Carbon::parse($payment->created_at)->format('Y-m-d') }}</span>
                <h1>Estado</h1>
    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: right; font-size: 12px;" colspan="5">Detalle del tratamiento</th>
            </tr>
            <tr style="text-align: left; background-color: #5de2c9; border: 2px solid #5de2c9;">
                <th width="15px">Pago</th>
                <th>Descripción</th>
                <th style="text-align: center" width="120px">Fecha de pago</th>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                ...
                <th style="text-align: center; font-size: 12px;" colspan="2">Costo total</th>
                <th style="text-align: center; font-size: 12px;">${{$payment->price_total}}</th>
            </tr>
            </tbody>
        </table>
    </div>
