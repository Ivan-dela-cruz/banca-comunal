<div {{  $visibleFrame["3"]?'':'hidden' }} class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5">
    ...
    <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Télefono/Celular</div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Actividad Económica</div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Tipo de Contrato</div>
            <input wire:model="contract_type" type="text" class="input w-full border flex-1" placeholder="">
            @error('type_contract') <li class="text-theme-6">{{$message}}</li>  @enderror
        </div>
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Empresa Donde Labora </div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Dirección de la Empresa </div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Tiempo de Servicio </div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Profesión u Oficio </div>
        ...
        <div class="intro-y col-span-12 sm:col-span-6">
            <div class="mb-2">Cargo Actual </div>
