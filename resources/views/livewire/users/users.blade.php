<div>
                        ...
                        <div class="intro-y p-5">
                                ...
                                <div class="text-right mt-5">
                                        <button wire:click.prevent="resetFields()" type="button"
                                                class="button w-24 border dark:border-dark-5 text-gray-700 dark:text-gray-300 mr-1">Cancelar</button>
                                        @if ($action=="PUT")
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <h2 class="intro-y text-lg font-medium ">Listado de usuarios</h2>
                                                ...
                                                <td class="table-report__action w-56">
                                                        <div class="flex justify-center items-center">
                                                                ...
                                                                <a wire:click.prevent="delete({{ $us->id }})" href="javascript:;" 
                                                                        ...
                                                                        <i class="fas fa-trash-alt w-4 h-4 mr-1"></i>
                                                                </a>
                                                        </div>
                                                </td>
                                        </tr>
