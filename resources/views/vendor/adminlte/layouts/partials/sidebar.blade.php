...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-bar-chart'></i> <span>Movimientos</span> <i
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-balance-scale'></i> <span>Balance</span> <i
                        class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-code-fork'></i> <span>Categorias</span> <i
                        class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-bank'></i> <span>Cuentas</span> <i
                        class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
            ...
            <li><a href="{{ url('transfer/create') }}"><i class='fa fa-money'></i> <span>Transferencias</span></a>
            <li><a href="{{ url('tours/tours') }}"><i class='fa fa-globe'></i> <span>Servicios</span></a></li>
            {{--<li class="treeview">--}}
            ...
            {{--
                ...
                <li><a href="{{ url('futuro/futuro') }}"><i class='fa fa-fast-forward'></i> <span>Movimientos
                Futuros</span></a>
